  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Voices from the Field</h2>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 max-w-4xl mx-auto">
            ...
            <blockquote className="text-xl text-gray-700 text-center mb-6 italic">
              "Now I can hold our governor accountable for the promises made to our youth during campaigns."
            </blockquote>
            <div className="text-center">
              <div className="font-semibold text-gray-900">Chioma Okafor</div>
              <div className="text-sm text-gray-600">Youth Leader, Anambra</div>
            </div>
